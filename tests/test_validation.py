...
class TestGuessValidation:
    ...
    def test_guess_non_integer_returns_400(self, client: Any, sample_game: Any):
    ...
    def test_guess_negative_number_rejected(self, client: Any, sample_game: Any):
    ...
    def test_guess_zero_rejected(self, client: Any, sample_game: Any):
    ...
    def test_guess_above_range_easy(self, client: Any):
    ...
    def test_guess_below_range(self, client: Any, sample_game: Any):
    ...
    def test_guess_decimal_number(self, client: Any, sample_game: Any):
    ...
    def test_guess_very_large_number(self, client: Any, sample_game: Any):
    ...
    def test_guess_float_as_string(self, client: Any, sample_game: Any):
    ...
    def test_guess_null_value(self, client: Any, sample_game: Any):
    ...
    def test_guess_missing_field(self, client: Any, sample_game: Any):
        """Test request without guess field"""
        response = client.post(f'/game/{sample_game}/guess', json={})
        assert response.status_code == 400
    
    def test_guess_empty_json(self, client: Any, sample_game: Any):
...
class TestRangeValidation:
    ...
    def test_valid_range_accepted(self, client: Any, difficulty: Literal['easy'] | Literal['medium'] | Literal['hard'], min_val: Literal[1], max_val: Literal[50] | Literal[100] | Literal[200]):
    ...
    def test_out_of_range_rejected(self, client: Any, difficulty: Literal['easy'] | Literal['medium'] | Literal['hard'], invalid_guess: Literal[51] | Literal[100] | Literal[101] | Literal[200] | Literal[201] | Literal[300]):
